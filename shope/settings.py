...
SECRET_KEY = "django-insecure-b0q-1iim529l%qgtcei$!_p_es^)0bzz175_l!lymmc40x%_8d"
...
MEDIA_PATH = BASE_DIR / MEDIA_FOLDER_NAME
if not os.path.exists(MEDIA_PATH): os.mkdir(MEDIA_FOLDER_NAME)
if not os.path.exists(MEDIA_PATH/'.gitkeep'):
	f = open(MEDIA_PATH/'.gitkeep', 'w')
	f.close()
